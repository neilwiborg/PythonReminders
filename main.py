...
class MAIN():
    ...
    def draw_screen():
        ...
        self.textbox = tkinter.Text(top, width=50, height=10).pack()
        save_button = tkinter.Button(top, text="Save", command=lambda: save_reminder(textbox.get("1.0", 'end-1c'))).pack()
        top.mainloop()
